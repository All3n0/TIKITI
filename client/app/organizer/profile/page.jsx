              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={field} className="space-y-1">
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2 border ${errors[field] ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 text-gray-500 focus:text-gray-800 transition-colors`}
                      required={required}
                    />
                ...
                <div className="col-span-full space-y-1">
                  ...
                  <textarea
                    ...
                    rows="4"
                    className={`w-full px-4 py-2 border ${errors.description ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 text-gray-500 focus:text-gray-800 transition-colors`}
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                {organizer.logo ? (
                  ...
                  <div className="w-24 h-24 bg-amber-100 rounded-lg flex items-center justify-center">
                    <span className="text-2xl font-bold text-amber-600">{organizer.name.charAt(0)}</span>
                  </div>
                )}
                <div className="flex-1">
                  <h2 className="text-xl font-bold text-gray-800">{organizer.name}</h2>
                  <p className="text-gray-600 mt-1">{organizer.speciality}</p>
                  <p className="text-gray-500 text-sm mt-2">{organizer.description}</p>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${organizer.email}`} className="text-gray-800 hover:text-amber-600 hover:underline">
                        {organizer.email}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href={`tel:${organizer.phone}`} className="text-gray-800 hover:text-amber-600 hover:underline">
                        {organizer.phone}
                      </a>
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      {organizer.website ? (
                        <a 
                          ...
                          className="text-gray-800 hover:text-amber-600 hover:underline"
                        >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      {organizer.contact_email ? (
                        <a href={`mailto:${organizer.contact_email}`} className="text-gray-800 hover:text-amber-600 hover:underline">
                          {organizer.contact_email}
                        </a>
                      ) : (
                        <span className="text-gray-400">Not provided</span>

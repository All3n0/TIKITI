            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="px-4 py-2 bg-teal-600 text-white text-sm font-medium rounded-lg hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 disabled:opacity-70 transition-colors flex items-center gap-2"
                >
                  {isSubmitting ? (
                    <>
                ...
                <div className="flex gap-3">
                  {(venue.status === 'pending' || venue.status === 'rejected') && (
                    <button
                      ...
                      disabled={isSubmitting}
                      className="flex items-center gap-2 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-70 transition-colors"
                    >
                  ...
                  {(venue.status === 'pending' || venue.status === 'approved') && (
                    <button
                      ...
                      disabled={isSubmitting}
                      className="flex items-center gap-2 bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-70 transition-colors"
                    >
                      <X className="w-5 h-5" />
                      Reject
                    </button>
